def player_choice_cards(player_cards, table):
    ...
    while True:
        player_input = input("Please Choose How Many Cards You Want To Select: ")
        if player_input.isnumeric():
            if 0 < int(player_input) < 5:
                break
            else:
    ...
    while int(player_input) > count:
        ...
        if player_choice in player_cards:
            ...
            print("Please Choose The Cards You Have")
            continue

    return player_cards, table
